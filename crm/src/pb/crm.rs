...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_user(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateUseRequest>,
        ) -> std::result::Result<tonic::Response<super::User>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub mod user_service_server {
    ...
    pub trait UserService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn create_user(
            &self,
            request: tonic::Request<super::CreateUseRequest>,
        ) -> std::result::Result<tonic::Response<super::User>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/crm.UserService/CreateUser" => {
                    ...
                    impl<T: UserService> tonic::server::UnaryService<super::CreateUseRequest> for CreateUserSvc<T> {
                        type Response = super::User;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
